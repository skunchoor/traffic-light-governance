...
async def ingest_github_webhook(request: Request, db: AsyncSession = Depends(get_db)):
    ...
    if event_type == "pipeline":
        ...
        if prun:
            ...
            if data.get("project") or data.get("repo"):
                prun.project = data.get("project", data.get("repo", prun.project))
            if data.get("stages"):
            ...
            prun = PipelineRun(
                ...
                project=data.get("project", data.get("repo", "skunchoor/traffic-light-governance")),
        ...
        for scan_data in scans:
            s = SecurityScan(
                ...
                project=scan_data.get("project", data.get("project", data.get("repo", prun.project))),
        ...
        grep = GatekeeperReport(
            ...
            repo=data.get("repo", data.get("project", "skunchoor/traffic-light-governance")),
        ...
        dep = Deployment(
            ...
            project=data.get("project", data.get("repo", "skunchoor/traffic-light-governance")),
            component=data.get("component", "Azure Container Registry"),
